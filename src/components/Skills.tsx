      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {skillCategories.map((category, index) => {
            ...
            return (
              <Card 
                key={category.title}
                className="p-6 bg-white/80 backdrop-blur-sm border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:-translate-y-2 group"
        ...
        <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-cyan-50 rounded-3xl p-8 border border-purple-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {["Python", "Java", "UI/UX", "Django"].map((skill, index) => (
