        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-16">
          {services.map((service, index) => {
            ...
            return (
              <Card 
                key={service.title}
                className="p-8 bg-white/80 backdrop-blur-sm border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group overflow-hidden relative"
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <Button 
                    className={`w-full bg-gradient-to-r ${service.color} hover:opacity-90 text-white font-semibold py-3 rounded-2xl transition-all duration-300 group-hover:scale-105 shadow-lg hover:shadow-xl`}
        ...
        <div className="text-center">
          <Card className="p-8 bg-gradient-to-r from-purple-600 to-blue-600 text-white max-w-4xl mx-auto shadow-2xl border-0 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Button 
                className="bg-white text-purple-600 hover:bg-gray-100 font-semibold px-8 py-3 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
              >
